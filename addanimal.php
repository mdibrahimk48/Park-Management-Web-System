        ...
        <div class="mainmenu">
           ...
           <div class="right">
              ...
              <ul>
                ...
                <li><a class="active" href="addanimal.php">Add Animal</a></li>
...
$connect=mysqli_connect("localhost","root","","park_sept17");
			if(@$_POST['insert']){
					...
					if($_FILES['animal_image']){
						...
						if ((($_FILES["animal_image"]["type"] == "image/gif")
						 ...
						 && ($_FILES["animal_image"]["size"] < 50000000)){
							...
							values('','$animal_name','image/$animal_image','$animal_description','$animal_quantity')";
							$result= mysqli_query($connect,$query);
							if(!$result){
								echo "<center>Error: </center>".mysqli_error($connect);
							}
							else{
								echo "<center>Animal Data Inserted.</center>";
							}
				...
				if(!$result){
					...
					echo "<center>Animal Data Deleted. </center>";	}}}?>
	...
	<body>
			...
			<caption style="font-size:30px">Animal Information</caption>
				...
				<tr>
					...
					<td><input type="file" id="animal_image" name="animal_image" /></td>
				</tr>
				<tr>
					<td><label>Animal Description:</label></td>
					<td><input type="text" name="animal_description"></td>
				</tr>
				<tr>
					<td><label>Animal Quantity:</label></td>
					<td><input type="number" name="animal_quantity" /></td>
				</tr>
				<tr> 
					<td colspan="2" align="middle"><input type="submit" value="Add Animal" name="insert" 
