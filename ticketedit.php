			...
			if(@$_POST['edit']){
				...
				if($ticket_type==null||$ticket_price==null||$ticket_image==null||$ticket_description==null||$quantity==null){
					echo "<center>Some of The Fields Are Blank. Please Insert Data.</center>";
						...
						$query="update ticket set ticket_type='$ticket_type', ticket_price='$ticket_price', ticket_image='image/$ticket_image', 
						ticket_description='$ticket_description',quantity='$quantity' where ticket_no='$ticket_no'";
						$result= mysqli_query($connect,$query);
						if(!$result){
							echo "Error: ".mysqli_error($connect);
						}else{
							echo "<center>Ticket Data Edited.</center>";
						}
					}else{
	...
	<body>
			...
			<caption style="font-size:30px">Ticket Information</caption>
				...
				<tr>
					...
					<td><input type="text" name="ticket_price" value="<?php echo $ticket_price;?>"/></td>
				</tr>
				<tr>
					<td><label>Ticket Image:<label></td>
					<td><input type="file" id="ticket_image" name="ticket_image" value="<?php echo $ticket_image;?>"/></td>
				</tr>
				<tr>
					<td><label>Ticket Description:</label></td>
					<td><input type="text" name="ticket_description" value="<?php echo $ticket_description;?>"></td>
				</tr>
				<tr>
				...
				<tr> 
					...
					<input type="hidden" value="<?php echo $_GET["ticket_no"]?>" name="ticket_no"/>
